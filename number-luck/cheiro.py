...
CHEIRO_UI = {
    ...
    "mm": {"head": "🔢 နိုင်ငံတကာသုံး ပေါင်းစပ်ဂဏန်း (Cheiro)", "compound": "ပေါင်းလဒ်၏ ပေါင်းစပ်ဂဏန်း",
           "single": "ပေါင်းလဒ်ကို လျှော့တွက်လိုက်သောအခါ ဂဏန်းတစ်လုံးတည်း ဖြစ်သွားသဖြင့် ဤကျမ်းအရ ပေါင်းစပ်ဂဏန်း မရှိပါ။",
           "tone": {"ดี": "မင်္ဂလာရှိ", "ระวัง": "သတိထားရန်", "กลาง": "အလယ်အလတ်"},
           "mulank_head": "🕉️ အိန္ဒိယနည်း လိုက်ဖက်မှု (Mulank)",
           "mulank_line": "သင့်စိတ်ဂဏန်း (မွေးနေ့ရက် {d} မှ) = {m} ({pm}) × နံပါတ်ပေါင်းလဒ်၏ မူလဂဏန်း = {r} ({pr})",
           "note": "အနောက်တိုင်း/အိန္ဒိယ ဂဏန်းဗေဒင် ရှုထောင့်ဖြစ်သည် — ဂြိုဟ်သတ်မှတ်ပုံမှာ အထက်ပါ မြန်မာစနစ်နှင့် ကွာခြားသဖြင့် ဖြည့်စွက်အချက်အလက်အဖြစ်သာ မှတ်ယူပါ။"},
}

# ดาวแบบอินเดีย (สำหรับชั้นนี้เท่านั้น)
INDIAN_PLANET = {
    1: {"th": "อาทิตย์ (Surya)", "en": "Sun (Surya)", "mm": "နေ (Surya)"},
    2: {"th": "จันทร์ (Chandra)", "en": "Moon (Chandra)", "mm": "လ (Chandra)"},
...
_BASE = {
    10: {"tone": "ดี", "name": {"th": "กงล้อโชคชะตา", "en": "Wheel of Fortune", "mm": "ကံကြမ္မာစက်ဝန်း"},
         "text": {"th": "เลขแห่งการขึ้น-ลงตามการกระทำ ชื่อเสียงเด่นดัง แผนการมักสำเร็จตามที่ตั้งใจ",
                  ...
                  "mm": "မိမိ၏ လုပ်ရပ်ပေါ်မူတည်၍ အတက်အကျရှိသော ဂဏန်း၊ နာမည်ကျော်ကြားပြီး ရည်ရွယ်ထားသည့် အစီအစဉ်များ အောင်မြင်တတ်သည်။"}},
    11: {"tone": "ระวัง", "name": {"th": "สิงห์ถูกล่าม", "en": "Hidden Trials", "mm": "လျှို့ဝှက် အခက်အခဲများ"},
         "text": {"th": "เตือนเรื่องอุปสรรคซ่อนเร้นและการถูกหักหลังจากคนใกล้ตัว ควรเลือกคบคนรอบข้างอย่างระวัง",
                  ...
                  "mm": "ဖုံးကွယ်နေသော အခက်အခဲများနှင့် အနီးအနားရှိသူများ၏ သစ္စာဖောက်မှုကို သတိပေးသည်၊ မိတ်ဆွေရွေးချယ်ရာတွင် သတိထားပါ။"}},
    12: {"tone": "ระวัง", "name": {"th": "ผู้ถูกพลี", "en": "The Sacrifice", "mm": "စတေးခံရသူ"},
         "text": {"th": "เสี่ยงตกเป็นเหยื่อแผนของผู้อื่น หรือต้องเสียสละเพื่อคนอื่นบ่อยครั้ง ควรรักษาสิทธิ์ของตนเอง",
                  ...
                  "mm": "သူတစ်ပါး၏ အကြံအစည်တွင် သားကောင်ဖြစ်တတ်ပြီး သူများအတွက် စွန့်လွှတ်ရမှု များတတ်သည်၊ မိမိအခွင့်အရေးကို ကာကွယ်ပါ။"}},
    ...
    15: {"tone": "ดี", "name": {"th": "วาทะและเสน่ห์", "en": "Eloquence & Charm", "mm": "နှုတ်ပါရမီနှင့် ဆွဲဆောင်မှု"},
         "text": {"th": "เสน่ห์แรง พูดจาโน้มน้าวเก่ง ได้ลาภได้ของขวัญจากผู้อื่น เหมาะงานที่ใช้วาจาและศิลปะ",
                  ...
                  "mm": "ဆွဲဆောင်မှုအားကောင်းပြီး စည်းရုံးပြောဆိုတတ်သည်၊ လက်ဆောင်နှင့် ကျေးဇူးများ လွယ်ကူစွာ ရရှိမည်။ စကားပြောနှင့် အနုပညာဆိုင်ရာ အလုပ်များနှင့် သင့်တော်သည်။"}},
    ...
    18: {"tone": "ระวัง", "name": {"th": "ศึกภายใน", "en": "Conflict & Materialism", "mm": "ပဋိပက္ခနှင့် ရုပ်ဝတ္ထုစွဲ"},
         "text": {"th": "ระวังความขัดแย้ง การหลอกลวง และวัตถุบังตา ควรทำสิ่งต่างๆ อย่างตรงไปตรงมา",
                  ...
                  "mm": "ရန်ဖြစ်ခြင်း၊ လှည့်ဖြားခြင်းနှင့် ရုပ်ဝတ္ထုလောဘကြောင့် ဆုံးဖြတ်ချက် မှားတတ်သည်၊ ရိုးသားဖြောင့်မတ်စွာ ဆောင်ရွက်ပါ။"}},
    ...
    20: {"tone": "กลาง", "name": {"th": "การตื่นรู้", "en": "The Awakening", "mm": "နိုးထခြင်း"},
         "text": {"th": "เลขแห่งการเริ่มแผนใหม่และการเรียกร้องให้ลงมือ อาจมีความล่าช้าแต่ได้ผลด้านจิตใจมากกว่าวัตถุ",
                  ...
                  "mm": "အစီအစဉ်သစ် စတင်ရန်နှင့် လက်တွေ့လှုပ်ရှားရန် နှိုးဆော်သော ဂဏန်း၊ နှောင့်နှေးမှု ရှိနိုင်သော်လည်း ရုပ်ဝတ္ထုထက် စိတ်ပိုင်းဆိုင်ရာ အကျိုးက ပိုများမည်။"}},
    ...
    26: {"tone": "ระวัง", "name": {"th": "ภัยจากหุ้นส่วน", "en": "Grave Warnings", "mm": "ပြင်းထန်သော သတိပေးချက်"},
         "text": {"th": "เตือนแรงเรื่องเสียหายจากการเก็งกำไร หุ้นส่วน และคำแนะนำผิดๆ อย่าลงทุนตามคนอื่นโดยไม่ตรวจสอบ",
                  ...
                  "mm": "လောင်းကြေးဆန်သော ရင်းနှီးမြှုပ်နှံမှု၊ လုပ်ဖော်ကိုင်ဖက်နှင့် အကြံဉာဏ်မှားများကြောင့် ဆုံးရှုံးနိုင်သည်၊ ရင်းနှီးမြှုပ်နှံခြင်း မပြုမီ သေချာစိစစ်ပါ။"}},
    ...
    29: {"tone": "ระวัง", "name": {"th": "เมฆหมอกแห่งใจ", "en": "Uncertainties", "mm": "မရေရာမှုများ"},
         "text": {"th": "ระวังความไม่แน่นอน การหลอกลวง และความเศร้าจากคนใกล้ตัว ควรมีหลักยึดทางใจที่มั่นคง",
                  ...
                  "mm": "မရေရာမှု၊ လှည့်ဖြားမှုနှင့် အနီးအနားရှိသူများကြောင့် စိတ်ဆင်းရဲရမှုကို သတိထားပါ၊ စိတ်ဓာတ်ခိုင်မာအောင် ထိန်းသိမ်းပါ။"}},
    30: {"tone": "กลาง", "name": {"th": "นักคิดผู้สันโดษ", "en": "Thoughtful Deduction", "mm": "တွေးခေါ်ဆင်ခြင်သူ"},
         "text": {"th": "ปัญญาเหนือคนทั่วไปแต่ไม่เน้นวัตถุ ผลลัพธ์ขึ้นกับว่าเลือกใช้ความคิดไปทางไหน",
                  ...
                  "mm": "ထူးချွန်သော ဉာဏ်ရှိသော်လည်း ရုပ်ဝတ္ထုကို အလေးမထားတတ်ပါ၊ ရလဒ်မှာ ထိုဉာဏ်ကို မည်သို့ အသုံးချသည့်အပေါ် မူတည်သည်။"}},
...
MULANK_VERDICT = {
    2: {"th": "มหามิตร — ผลรวมเบอร์หนุนเลขจิตของคุณเต็มกำลัง ตามคติอินเดียถือว่าส่งเสริมกันดีมาก",
        ...
        "mm": "မိတ်ကောင်း — ဖုန်းနံပါတ်၏ စွမ်းအင်က သင့်စိတ်ဂဏန်းကို အပြည့်အဝ ထောက်ပံ့ပေးသည်။"},
    ...
    -1: {"th": "ต้องปรับตัว — พลังคนละสาย ตามคติอินเดียแนะให้เสริมด้วยเลขกลาง (เช่นรากผลรวม 5) ในเบอร์ถัดไป",
         ...
         "mm": "ညှိနှိုင်းရန် လိုသည် — စွမ်းအင်လမ်းကြောင်း ကွဲပြားနေသဖြင့် နောက်တစ်ကြိမ်တွင် မူလဂဏန်း အလယ်အလတ် (၅) ဖြစ်သည့် နံပါတ်ကို ရွေးရန် အိန္ဒိယဓလေ့က အကြံပြုသည်။"},
    -2: {"th": "คู่ขัด — ตามตำราอินเดียถือว่าดาวเป็นศัตรูกัน หากใช้แล้วรู้สึกติดขัด อาจพิจารณาเบอร์ที่รากผลรวมเป็นมิตรกับเลขจิต",
         ...
         "mm": "ဆန့်ကျင်ဘက် — အိန္ဒိယကျမ်းအရ ဂြိုဟ်ချင်း ရန်ဖက်ဖြစ်နေသည်၊ သင့်စိတ်ဂဏန်းနှင့် မိတ်ဆွေဖြစ်သည့် မူလဂဏန်းပါသော နံပါတ်သို့ ပြောင်းသုံးရန် စဉ်းစားနိုင်သည်။"},
}
